...
namespace DistinctDemo.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase postedFile)
        {
            ...
            {
                model.PortraitPath = "default-user.png";
            }
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser {
                    ...
                    Gender = model.Gender,
                    Age = model.Age,
                    PortraitPath = model.PortraitPath
                };
        ...
        public async Task<ActionResult> Email(EmailFormModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //message.To.Add(new MailAddress("xzha0006@student.monash.edu"));  // replace with valid value 
                //message.From = new MailAddress("sender@outlook.com");  // replace with valid value
                message.From = new MailAddress("xzha0006@student.monash.edu");  // replace with valid value
                ...
                using (var smtp = new SmtpClient())
                {
                    ...
                    {
                        UserName = "xzha0006@student.monash.edu",  // replace with valid value
                        Password = "MUzx256918@"                                 // Password = "password"  // replace with valid value
                    };
        ...
        public ActionResult GetEmails(string[] emails)
        {
            emailList = emails;
